...
<div class="mt-20 mx-auto w-11/12">
	...
	{#each searches as item}
		<a
			...
			key={item._id}
			class="flex items-center justify-between gap-2 bg-gray-100 dark:bg-gray-800 p-2 rounded-md my-1 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-900 transition duration-300"

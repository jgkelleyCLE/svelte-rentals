<script>
	...
	const metaDescription =
		'Find everything you need for your event. We offer rental equipment for corporate events, weddings, church picnics, graduations and more. Simply the best Cleveland tent, table, and chair rental!';
</script>
	...
	<div class="absolute top-0 left-0 w-full h-[100vh] bg-black/55 z-10">
		...
		>
			<div class="flex flex-col items-center mx-4">
				...
				<h1
					class={`text-white md:text-5xl text-3xl uppercase font-bold mb-5 ${fade ? 'fade-in' : 'fade-out'}`}
				>
